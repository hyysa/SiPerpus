...
<!-- bootstrap -->
<script src="{{ asset('') }}assets/dist/js/bootstrap.bundle.min.js" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous"></script>
{{-- datatables --}}
<script src="{{ asset('') }}assets/dist/js/jquery-3.5.1.js"></script>
<script src="{{ asset('') }}assets/dist/js/jquery.dataTables.min.js"></script>
<script src="{{ asset('') }}assets/dist/js/dataTables.bootstrap5.min.js"></script>
